...
ActiveRecord::Schema.define(version: 2021_12_28_144621) do
  ...
  create_table "client_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["business_unit_id"], name: "index_client_relationships_on_business_unit_id"
  ...
  add_foreign_key "client_relationships", "business_units"
